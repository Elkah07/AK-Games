...
const CACHE_VERSION = "akgames-v4.25-project-cleanup";

const CORE_SHELL = [
  "/",
  "/index.html",
  "/styles/styles.css?v=ui-v58-home-gradient",
  "/styles/creator.css?v=creator-v1.3-access",
  "/styles/character-poses.css?v=characters-v5",
  "/scripts/app.js?v=ui-v61-core-audit",
  "/scripts/creator.js?v=creator-v1.3-access",
  "/scripts/firebase.js?v=firebase-v3-presence-grace",
  "/scripts/multiplayer.js?v=ui-v61-core-audit",
  "/scripts/character-poses.js?v=characters-v5",
  "/scripts/sound-manager.js?v=sound-v1",
  "/scripts/character-voice-engine.js?v=characters-v5",
  "/scripts/characters.js?v=characters-v11-multi-stable",
  "/scripts/game-help.js?v=ui-v48",
  "/scripts/settings.js?v=settings-v4.14",
  "/scripts/pwa.js",
