...
const CACHE_VERSION = "akgames-v4.0-sorted-characters";

const CORE_SHELL = [
  "/",
  "/index.html",
  "/styles.css?v=characters-v4",
  "/character-poses.css?v=characters-v4",
  "/creator.css?v=creator-v1.3-access",
  "/app.js?v=characters-v4",
  "/creator.js?v=creator-v1.3-access",
  "/firebase.js",
  "/multiplayer.js?v=characters-v4",
  "/character-poses.js?v=characters-v4",
  "/character-voice-engine.js?v=characters-v4",
  "/characters.js?v=characters-v4",
  "/game-help.js?v=characters-v4",
  "/pwa.js",
