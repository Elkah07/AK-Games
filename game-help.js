(function () {
  ...
  const RULES = {
    ...
    "Alerte Rouge": { intro: "Le groupe affronte 500 mini-aventures interactives, de la petite galère au chaos paranormal.", steps: ["Choisissez les univers et les intensités.", "Un scénario propose trois décisions réellement différentes.", "Tout le monde vote secrètement.", "La décision majoritaire déclenche immédiatement sa conséquence."], scoring: "Chaque personne ayant voté pour la décision majoritaire gagne 1 point. En cas d’égalité, l’une des options à égalité est tirée au sort.", options: "5 à 50 scénarios, 10 univers et 4 intensités combinables.", comfort: "Les histoires sont fictives. Elles ne demandent aucune action réelle risquée et le vote ne représente pas forcément les valeurs des joueurs." },
    "Questions osées": {
